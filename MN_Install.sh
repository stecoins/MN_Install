#!/bin/bash
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='SATELLITE.conf'
CONFIGFOLDER='/root/.SATELLITE'
COIN_DAEMON='satellited'
COIN_CLI='satellite-cli'
COIN_PATH='/usr/local/bin/'
COIN_GETDMN='https://github.com/stecoins/STECOIN/releases/download/1.0.0.0/satellited'
COIN_GETCLI='https://github.com/stecoins/STECOIN/releases/download/1.0.0.0/satellite-cli'
COIN_NAME='SATELLITE'
COIN_EXPLORER='http://207.148.70.241'
COIN_PORT=33229
RPC_PORT=33230
